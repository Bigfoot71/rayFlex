...
namespace rf { namespace net {
    ...
    {
      protected:
        TSQueue<OwnedPacket<T_PacketID>> packetsIn;                             ///< Thread Safe Queue for incoming message packets
        ...
        uint32_t IDCounter = 0;                 ///< Clients will be identified in the "wider system" via an ID
      ...
      public:
        ...
        {
            InitSodium(); // Initialize libsodium if necessary
        }
